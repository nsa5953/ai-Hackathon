...
export const { setActiveCard, toggleCards, applyBrandFilter, setYaxisData, setActivePage } = hackSlice.actions
...
export const selectActivePage = (state: RootState) => state.hack.activePage
