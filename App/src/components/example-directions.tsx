          ...
          <div className="d-flex flex-wrap">
            <div className="form-group custom-control custom-radio mr-4">
              <input
                ...
                name="travelMode"
                type="radio"
                checked={directionsFormValue.travelMode === "DRIVING"}
            ...
            <div className="form-group custom-control custom-radio mr-4">
              <input
                ...
                name="travelMode"
                type="radio"
                checked={directionsFormValue.travelMode === "BICYCLING"}
            ...
            <div className="form-group custom-control custom-radio mr-4">
              <input
                ...
                name="travelMode"
                type="radio"
                checked={directionsFormValue.travelMode === "TRANSIT"}
            ...
            <div className="form-group custom-control custom-radio mr-4">
              <input
                ...
                name="travelMode"
                type="radio"
                checked={directionsFormValue.travelMode === "WALKING"}
